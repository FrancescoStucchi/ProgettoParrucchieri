        ...
        <div>
            ...
            <% 
                try{
                    ...
                    session.setAttribute("paginaPrecedente", "schedaSegretariAmministratore.jsp");
        ...
        <tbody>
            <%
                ...
                while(rs.next()){
                    ...
                    out.println("<td><button class='modifica-btn' onclick=\"window.location.href='modificaSegretario.jsp?id=" + rs.getInt("id") + "'\">Modifica</button></td>");
                    out.println("<td><button class='elimina-btn' onclick=\"window.location.href='eliminaSegretario.jsp?id=" + rs.getInt("id") + "'\">Elimina</button></td>");
                    out.println("</tr>");    
                }  
                } catch (Exception e) {
